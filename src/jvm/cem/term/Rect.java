...
public final class Rect {
  ...
  public static final void bytesToCell(int[] bytes, Cell cell) {
    cell.codePoint = bytes[0];
    final int fgColor = bytes[1];
  ...
  public final int rowColToIndex(final int row, final int col) {
    assert row >= 0;
    assert col >= 0;
  ...
  public final Cell getCellIfDifferent(final int row, final int col, Rect other) {
    final int i = rowColToIndex(row, col);
